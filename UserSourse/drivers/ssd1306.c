...
uint8_t SSD1306_Init(void) {
	...
	SSD1306_WRITECOMMAND(0xB0); //Set Page Start Address for Page Addressing Mode,0-7 (b0-b7)
	SSD1306_WRITECOMMAND(SSD1306_COMSCANDEC); //Set COM Output Scan Direction
...
void SSD1306_WRITECOMMAND(uint8_t command){
	...
	I2C_WriteData(I2C1,CONTROL_BYTE_COMMAND);
	I2C_WriteData(I2C1,command);
...
{
	I2C_StartTransmission( I2C1, I2C_Direction_Transmitter,  SSD1306_I2C_ADDR);
	I2C_WriteData(I2C1,CONTROL_BYTE_DATA);
